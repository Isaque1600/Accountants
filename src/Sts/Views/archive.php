...
<body>
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <header>
                ...
                <form class="form" action="" method="get">
                    ...
                    <div class="custom-select yearpicker">
                        <button type="button" class="select-btn">
                            <input class="selected-value" id="selected-value" name="year"
                                value="<?php echo $data['date']['year'] ?>" readonly />
                    ...
                    <div class="custom-select namepicker">
                        <button type="button" class="select-btn">
                            <input class="selected-value" id="selected-value" name="name"
                                value="<?php echo $data['selected'] ?>" readonly />
            ...
            <main>
                <div class="top">
                    <div class="options">
                        <button class="download-btn files"><i data-feather="download"></i> Baixar</button>
                    </div>
                    <div class="info">
                ...
                <div class="content">
                    ...
                    <div class="head">
                        ...
                        <a href="<?php echo DEFAULT_URL ?>?sort=filename&order=<?php echo $data['order'] ?>&month=<?php echo $data['date']['month'] ?>&year=<?php echo $data['date']['year'] ?>&name=<?php echo $data['selected'] ?>"
                            class="name">
                            Nome do arquivo
                            <i
                                data-feather="<?php echo ($data['order'] == "ASC") ? "chevron-down" : "chevron-up" ?>"></i>
                        </a>
                        <a href="<?php echo DEFAULT_URL ?>?sort=size&order=<?php echo $data['order'] ?>&month=<?php echo $data['date']['month'] ?>&year=<?php echo $data['date']['year'] ?>&name=<?php echo $data['selected'] ?>"
                            class="size">
                            Tamanho
                            <i
                                data-feather="<?php echo ($data['order'] == "ASC") ? "chevron-down" : "chevron-up" ?>"></i>
                        </a>
                        <a href="<?php echo DEFAULT_URL ?>?sort=Mtime&order=<?php echo $data['order'] ?>&month=<?php echo $data['date']['month'] ?>&year=<?php echo $data['date']['year'] ?>&name=<?php echo $data['selected'] ?>"
                            class="Mtime">
                            Ultima modificação
                            <i
                                data-feather="<?php echo ($data['order'] == "ASC") ? "chevron-down" : "chevron-up" ?>"></i>
    ...
    <script type="text/javascript" src="<?php echo JS_URL ?>Ordering.js"></script>
